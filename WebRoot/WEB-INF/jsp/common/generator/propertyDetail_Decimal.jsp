					...
					<tr>
					 ...
					 <tr>
					  ...
					  <tr>
						<th>最大值</th>
						<td>
						<input type="text" name="maxValue" value="${genEntityProperty.maxValue}" class="easyui-numberbox easyui-validatebox"  data-options="required:false"/>
						</td>
						<th>最小值 </th>
						<td>
						<input type="text"  name="minValue" value='${genEntityProperty.minValue}' class="easyui-numberbox easyui-validatebox"  data-options="required:false"/>
						</td>
					 </tr>
					 	<tr>
						<th>数据长度</th>
						<td>
						<input type="text" name="precision" value="${genEntityProperty.precision}" class="easyui-numberbox easyui-validatebox"  data-options="required:false"/>
						</td>
						<th>小数位数 </th>
						<td>
						<input type="text"  name="scale" value='${genEntityProperty.scale}' class="easyui-numberbox easyui-validatebox"  data-options="required:false"/>
						</td>
					 </tr>
						<tr>
						<th>编辑类型</th>
