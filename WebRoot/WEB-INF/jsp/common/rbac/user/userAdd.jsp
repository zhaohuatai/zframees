...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false ," title="" style="overflow: hidden;padding: 10px;">
		<form id="formss" method="post" action="${ctx}/rbac/role/addUser">
				...
				<legend><img src="resources/images/fromedit.png" style="margin-bottom: -3px;"/>角色编辑</legend>
				 <table>
					 <tr>
						...
						<th>用户昵称</th>
						<td>
							<input type="text" id="code" name="rbacRole.code" value="${rbacRole.code}" class="easyui-textbox easyui-validatebox"  data-options="required:true" />
						</td>
					 </tr>
					 <tr>
						<th>是否启用</th>
