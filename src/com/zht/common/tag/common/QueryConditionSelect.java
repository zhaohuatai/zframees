...
public class QueryConditionSelect extends SimpleTagSupport{
	private String name;
	private String id;
	...
	private static String[] queryTpes=new String[]{"text","combox","lookup","date"};
	private static String[] queryTpeName=new String[]{"文本","下拉框","查找带回","日期"};
