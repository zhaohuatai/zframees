...
public class QueryTypeSelect extends SimpleTagSupport{
	private String name;
	private String id;
	...
	private static String[] queryTpes=new String[]{"=","<>",">",">=","<","<=","LIKE","NOT LIKE","IN","NOT IN"};
	private static String[] queryTpeName=new String[]{"等于","不等于","大于","大于等于","小于","小于等于","LIKE","NOT LIKE","IN","NOT IN" };
